...
function themify_shortcode_post_slider( $atts = array(), $content = null ) {
	...
	if ($posts) {
		...
		$js_data['height'] = $height;
		$js_data['numsldr'] = rand(0,1011).uniqid();
		$postsliderstr = '<!-- shortcode post_slider --> <div id="slider-' . esc_attr(  $js_data['numsldr'] ) . '" style="width: ' . esc_attr( $width ) . ';" class="themify-shortcodes-slider shortcode tf_clearfix post-slider ' . esc_attr( $class ) . '">
